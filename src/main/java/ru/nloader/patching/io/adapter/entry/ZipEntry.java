 ...
 *
 *  This file (ZipEntry.java) is part of nPatch.
 *
 ...
 */
public class ZipEntry extends CompressedEntry {

    public ZipEntry(String path, int size, byte[] data) {
        super(path, size, data);
    }
}
